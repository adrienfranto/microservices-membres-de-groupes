...
const Etudiant = () => {
  ...
  const ETUDIANT_API = "http://192.168.88.13:9000/api/etudiants";
  const GROUPE_API = "http://192.168.88.13:9000/api/groupes/list";
  ...
  const handleEdit = (etudiant) => {
    ...
    setImagePreview(etudiant.image ? `http://192.168.88.13:9000${etudiant.image}` : null);
    setImagePreview(etudiant.image ? `http://192.168.88.13:9000${etudiant.image}` : null);
    setIsEditing(true);
    setShowModal(true);
  };
                      ...
                      <div className="flex-shrink-0 h-12 w-12">
                        {etudiant.image ? (
                          <img
                            ...
                            src={`http://192.168.88.13:9000${etudiant.image}`}
                            alt={etudiant.nom}
                          />
                        ) : (
