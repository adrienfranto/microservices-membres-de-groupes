...
public class Routes {
    ...
    public RouterFunction<ServerResponse> etudiantServiceRoute(){
        return GatewayRouterFunctions.route("etudiant_service")
                .route(RequestPredicates.path("/api/etudiants/**"), HandlerFunctions.http("http://192.168.56.50:8080"))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> orderServiceRoute(){
        return GatewayRouterFunctions.route("travail_service")
                .route(RequestPredicates.path("/api/travail/**"),HandlerFunctions.http("http://192.168.56.50:8081"))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> inventoryRoute(){
        return GatewayRouterFunctions.route("groupe_service")
                .route(RequestPredicates.path("/api/groupes/**"),HandlerFunctions.http("http://192.168.56.50:8082"))
                .build();
    }
}
